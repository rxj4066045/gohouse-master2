package com.gohouse.gohouse.ui.customView.fab;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private Drawable mLabelsBackground;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mLabelsBackground = attr.getDrawable(R.styleable.FloatingActionMenu_menu_labels_background);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = mButtonsCount - 1; i >= 0; i--) {
            ...
            MarginLayoutParams params = (MarginLayoutParams) fab.getLayoutParams();
            int margin = params.bottomMargin;

            int childX = buttonsHorizontalCenter - fab.getMeasuredWidth() / 2;
            int childY = openUp ? nextY -margin- fab.getMeasuredHeight() - mButtonSpacing : nextY;
    ...
    private void addLabel(FloatingActionButton fab) {
        ...
        if (mLabelsStyle > 0) {
            ...
            if(mLabelsBackground != null)
                label.setBackgroundCompat(mLabelsBackground);
