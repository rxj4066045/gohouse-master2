package com.gohouse.gohouse.ui.customView;
...
public class ShapeImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mShape = ta.getInt(R.styleable.ShapeImageView_siv_shape, DEFAULT_SHAPE);
        mTextStyle = ta.getInt(R.styleable.ShapeImageView_siv_textStyle, Typeface.NORMAL);
        mTextColor = ta.getColor(R.styleable.ShapeImageView_siv_textColor, DEFAULT_TEXT_COLOR);
        mTextSize = ta.getDimensionPixelSize(R.styleable.ShapeImageView_siv_textSize, DisplayUtils.sp2px(context, DEFAULT_TEXT_SIZE));
        mText = ta.getString(R.styleable.ShapeImageView_siv_text);
        mBackgroundColor = ta.getColor(R.styleable.ShapeImageView_siv_backgroundColor, DEFAULT_BACKGROUND);
        mRadius = ta.getDimensionPixelSize(R.styleable.ShapeImageView_siv_radius, DEFAULT_RADIUS);
        mBorderWidth = ta.getDimensionPixelSize(R.styleable.ShapeImageView_siv_borderWidth, 0);
