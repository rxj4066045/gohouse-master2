...
public class PullToRefreshView extends LinearLayout {
    // refresh states
    private static final int PULL_TO_REFRESH = 2; //继续下拉才刷新，即松开后不刷新
    ...
    private boolean isCanRefreshHeader = true,isCanRefreshFooter = true;
    ...
    */
    ...
    private boolean isRefreshViewScroll(int deltaY) {
        ...
        if(deltaY <= 0 && !isCanRefreshFooter)
            return false;
...
//            }
            ...
            return !mScrollView.canScrollVertically(-deltaY);
        ...
        if(mRecyclerView != null){
            ...
            return !mRecyclerView.canScrollVertically(-deltaY);
        }
    ...
    private void headerPrepareToRefresh(int deltaY) {
        ...
        if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
            mHeaderTextView.setText("释放返回顶部");
            ...
            mHeaderImageView.startAnimation(mFlipAnimation);
            // mHeaderImageView.
            mHeaderTextView.setText("下拉返回顶部");
    ...
    private void footerPrepareToRefresh(int deltaY) {
        ...
        if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight)
            ...
            mFooterTextView.setText("释放查看更多详情");
            mFooterImageView.clearAnimation();
            mFooterImageView.startAnimation(mFlipAnimation);
            mFooterState = RELEASE_TO_REFRESH;
        } else if (Math.abs(newTopMargin) < (mHeaderViewHeight + mFooterViewHeight)) {
            mFooterTextView.setText("上拉查看更多详情");
            mFooterImageView.clearAnimation();
            mFooterImageView.startAnimation(mFlipAnimation);
