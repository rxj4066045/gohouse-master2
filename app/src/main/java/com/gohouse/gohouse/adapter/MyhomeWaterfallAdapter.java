...
public class MyhomeWaterfallAdapter extends RecyclerView.Adapter<MyhomeWaterfallAdapter.MyViewHolder> {
    private Context context;
    private List<String> list;
    //创建集合
    List<Integer> heights = new ArrayList<>();

    public MyhomeWaterfallAdapter(Context context, List<String> list) {
